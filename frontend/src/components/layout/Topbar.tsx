...
export default function Topbar({ onMenuClick, onSearch, onUploadClick }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b border-gray-200 bg-white px-4 sm:px-6 lg:px-8">
      <button
        type="button"
        className="lg:hidden"
        onClick={onMenuClick}
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 rounded-full p-1.5 transition-colors hover:bg-gray-100"
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-lg bg-white py-1 shadow-lg ring-1 ring-black/5">
            <div className="border-b border-gray-100 px-4 py-3">
              <p className="text-sm font-medium text-gray-900">Alex Morgan</p>
              <p className="text-xs text-gray-500">alex.morgan@vaultly.io</p>
            </div>
            <button
